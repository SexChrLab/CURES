...
>
>Describe how linear modeling can be used to identify differentially expressed genes
>Describe how to visualize sample groupings by gene expression profiles
>Describe why we conduct transformation and normalization of RNAseq data
>Describe the effects of trimming on data
>
>
>3.2 Coding (2+ hours, dep on coding experience)
>
>Run Rmd of differential expression analysis for default (untrimmed data)
>
>Visualize gene expression differences with volcano plots and box plots
>
>Visualize trends in samples based on their gene expression profiles with MDS plots
> 
...
>
>Conduct a pairwise correlation analysis of differential expression results 
>
>Generate a Venn diagram of pairwise overlap between two differential expression analyses
>
>Describe what a p-value is and what multiple hypothesis testing is.
>
>
>4.2 Coding (2 hours)
>
>Visualize overlap between two differentially expressed gene lists
>
...
>
>Describe how to decide overlap and differences between gene sets
>
>5.2 Coding (2 hours)
>
>Use an Upset.r plot to compare multiple differential expression experiments covering a range of analytical parameters
> 
>5.3 Research/Professional development (30 min)
>
>How to organize your results to write a research paper
...
>
>Summarize, interpret, and present findings in a mini research paper
> 
>6.2 Coding (30 min)
>
